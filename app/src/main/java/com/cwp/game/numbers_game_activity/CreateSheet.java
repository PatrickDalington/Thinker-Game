...
import com.cwp.game.numbers_game_activity.ChooseGameLevel;
import com.cwp.game.numbers_game_activity.DraggableNumbersFragment;
...
public class CreateSheet extends BottomSheetDialogFragment {
    ...
    private DraggableNumbersFragment draggableAlphabetFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        draggableAlphabetFragment = new DraggableNumbersFragment();
