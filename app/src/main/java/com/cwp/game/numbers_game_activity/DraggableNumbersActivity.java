...
import com.cwp.game.common.fragment.NumbersDataProviderFragment;

import androidx.appcompat.app.AppCompatActivity;
import androidx.fragment.app.Fragment;

public class DraggableNumbersActivity extends AppCompatActivity implements CreateSheet.PSheetListener{
    private static final String FRAGMENT_TAG_DATA_PROVIDER = "number provider";
    private static final String FRAGMENT_LIST_VIEW = "list view";
    Intent intent;
    String timer;
    DraggableNumbersFragment fragment;
    private DraggableNumbersAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(new NumbersDataProviderFragment(), FRAGMENT_TAG_DATA_PROVIDER)
                    .commit();
            getSupportFragmentManager().beginTransaction()
    ...
    public AbstractDataProvider getDataProvider() {
        ...
        return ((NumbersDataProviderFragment) fragment).getDataProvider();
    }
