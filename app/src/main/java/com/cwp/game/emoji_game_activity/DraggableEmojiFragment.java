...
public class DraggableEmojiFragment extends Fragment
        implements DraggableEmojiAdapter.ItemClickListener, CreateSheet.PSheetListener{
    private RecyclerView mRecyclerView;
    private RecyclerView.LayoutManager mLayoutManager;
    private DraggableEmojiAdapter mAdapter;
    ...
    private EmojisDataProvider dataProvider;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        dataProvider = new EmojisDataProvider();
...
//        mRecyclerViewDragDropManager.setDraggingItemRotation(10.0f);
        ...
        //adapter
        mAdapter = new DraggableEmojiAdapter(getActivity(), getDataProvider(), mRecyclerView, this, isMusicEnabled);
    ...
    public AbstractDataProvider getDataProvider() {
        return ((DraggableEmojiActivity) requireActivity()).getDataProvider();
    }
    ...
    public void onClick(int position, String value) {
        ...
        if (value.equals("completed") && !levelText.getText().equals("Practice"))
        {
            ...
            ft.detach(DraggableEmojiFragment.this).attach(DraggableEmojiFragment.this).commit();
